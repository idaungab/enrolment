 ...
 // fetch DEPARTMENT data
  ...
  render(){
    ...
    return(
      <div className="row">
        <div className="Entry">
          <Search name="search" placeholder="Search program. . ."  value={this.state.searchTerm} onChange={this.handleSearchChange}/>
          ...
          <Select label="Active" checked={this.state.isActive} onChange={this.handleSelectChange}/>
