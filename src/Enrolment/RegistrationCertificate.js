                ...
                <div className="courses">
                    <table>
                        ...
                        <tbody>
                            ...
                            {this.state.onepage && this.createTableCourses()}
                            {this.state.secondpage && this.createTableCoursesLimit()}
                        </tbody>
                    </table>                
                </div><br/>
                <hr/>
                            ...
                            <div className="courses">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        {this.createTableCoursesOverflow()}
                                    </tbody>
                                </table>                
                            </div><br/>
                            <hr/>
